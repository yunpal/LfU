...
class FinetuningArguments(
    ...
    mode: str = field(default="default", metadata={"help": "select the trainer"})

    weight: float = field(default=0.0, metadata={"help": "select the trainer"})

    alpha: float = field(default=0.0, metadata={"help": "select the trainer"})
    lr_weight: float = field(default=1.0, metadata={"help": "select the trainer"})

    first_n: int = field(default=0, metadata={"help": "select the trainer"})
    beta: float = field(default=0.0, metadata={"help": "select the trainer"})
    noise_scale: float = field(default=0.0, metadata={"help": "select the trainer"})
    start_layer: int = field(default=0, metadata={"help": "Start layer index (inclusive)"})
    finish_layer: int = field(default=0, metadata={"help": "Start layer index (inclusive)"})
