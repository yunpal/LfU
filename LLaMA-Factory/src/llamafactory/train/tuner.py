...
def _training_function(config: dict[str, Any]) -> None:
    ...
    dataset_b = args.pop("dataset_b", None)

    template_b = args.pop("template_b", None)
    ...
    args_b = deepcopy(args)
    args_b["dataset"] = dataset_b
    args_b["template"] = template_b   


    _, data_args_b, _, _, _ = get_train_args(args_b)
